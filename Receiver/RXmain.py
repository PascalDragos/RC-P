...
address_port_RX = ("127.0.0.1", 5005)
buffer_size = 512 + 8  # pachetul va contine 512B de data utila + antet
...
tahoe_congestion_control(sock, address_port_TX, buffer_size, 2)
